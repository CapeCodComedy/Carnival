...
JSONLD = {
  ...
  "description": "One night of stand-up at the Tilden Arts Center: Brendan Sagalow and Mike Cannon — Saturday, August 29, 2026, 7:00 PM. Every seat reserved; pick your exact seat on the live map. A flat $3 card-processing fee per seat is passed through at cost.",
  ...
  "performer": [ {"@type": "Person", "name": "Brendan Sagalow"}, {"@type": "Person", "name": "Mike Cannon"} ],
